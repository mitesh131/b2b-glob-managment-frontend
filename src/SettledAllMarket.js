...
function SettledAllMarket(props) {
    ...
    useEffect(() => {
        ...
        axios.post("https://liveapi247.live/api4/settle_Match_Market", {
            sid: ssid,
            eventId: event_Id,
        })
            .then((result) => {
    ...
    useEffect(() => {
        ...
        axios.post("https://liveapi247.live/api4/Decleared_fancy_Market", {
            sid: ssid,
            eventId: event_Id,
        })
            .then((result) => {
    ...
    const function_reversefancy = (id, bool, eid, sid) => {
        ...
        toast.warn('Kindly Reverse Market First', { position: toast.POSITION.TOP_CENTER });
    }
    ...
    const function_reverseMarket = (id, bool, eid, sid) => {
        ...
        toast.warn('Settled Reverse is comming soon ', { position: toast.POSITION.TOP_CENTER });
    }
...
export default SettledAllMarket
